        ...
        ?>      
                <div class="btn-group profil">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profil-link">
                        <button class="dropdown-item" type="button"><a href="pages/basket.php">Korpa <?= $db->num_rows($res) ?></a></button>
                        <button class="dropdown-item" type="button"><a href="pages/profil.php">Moj profil</a></button>
                        <button class="dropdown-item" type="button"><a href="pages/comments.php">Komentari</a></button>
                        <button class="dropdown-item" type="button"><a href="pages/logs.php">Logovi</a></button>
